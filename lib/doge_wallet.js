(function() {
  ...
  DogeWallet = (function(_super) {
    ...
    DogeWallet.prototype.initialCurrency = "DOGE";

    DogeWallet.prototype.currencyName = "Dogecoin";
    ...
    DogeWallet.prototype.getBalance = function(account, callback) {
      return this.client.getBalance(account, (function(_this) {
        return function(err, balance) {
          balance = _this.convert(_this.initialCurrency, _this.currency, balance.result);
          if (callback) {
