(function() {
  ...
  CryptoWallet = (function() {
    ...
    CryptoWallet.prototype.setupPassphrase = function(options) {
      return this.passphrase = options.wallet.passphrase || this.passphrase;
    };
    ...
    CryptoWallet.prototype.getBankBalance = function(callback) {
      return this.client.getBalance("*", (function(_this) {
        return function(responseOrErr, balance) {
          if (responseOrErr && (responseOrErr.result != null)) {
            return callback(responseOrErr.error, responseOrErr.result);
          }
          if (callback) {
            return callback(responseOrErr, balance);
          }
        };
      })(this));
    };
